...
#pragma mark Method to start using the API

// Method to start Fwix API
// Parameters
// fAPIKey : Required
// fUserId: Optional
+(void) startSession:(NSString *)fAPIKey userID:(NSString *)fUserID;
...
// Paramtes
// place: Required. If udid is abset location is required, else if udid is present all others are optional
// error: Optional, but recommended
